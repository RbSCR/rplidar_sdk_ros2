...
Copied from original Slamtec SDK repro (and slightly edited to -mostly- remove lint notifications)/

Original github repro: <https://github.com/Slamtec/rplidar_sdk>
...
If you are just evaluating RPLIDAR, you can use Slamtec RoboStudio (<https://www.slamtec.com/robostudio>) (currently only support Windows and Android) to do the evaluation.
...
Info about demo application has been removed. See the original github repro: <https://github.com/Slamtec/rplidar_sdk>
...
If you have any extra questions, please feel free to contact us at our support email: <support@slamtec.com>
